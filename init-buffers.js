...
function initColorBuffer(gl) {
  ...
  const faceColors = [
    [0.98, 0.93, 0.15, 1.0], // Face frontal: Amarelo
    [0.48, 1.0, 0.13, 1.0], // Face do fundo: Verde
    [1.0, 0.13, 1.0, 1.0], // Face de cima: Rosa 
    [1.0, 0.13, 0.35, 1.0], // Face de baixo: Vermelho
    [1.0, 0.55, 0.13, 1.0], // Face do topo: Laranja 
    [1.0, 1.0, 1.0, 1.0], // Face do topo: Branco
  ];
